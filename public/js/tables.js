...
function itemTableRowExpand(rowId) {
  // gather row elements
  var row = document.getElementsByClassName(rowId); // switch bottom border off on row
  ...
  var subRow = document.getElementsByClassName("sub-" + rowId); // toggle sub-row hiding (already has bottom border)
