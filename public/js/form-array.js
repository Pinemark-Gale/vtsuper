...
function enable(section) {
  // enable input
  section.childNodes[1].removeAttribute('disabled'); // change UI to reflect input

  section.classList.add('enabled');
  section.classList.remove('disabled'); // bind disable function
...
function disable(section) {
  // disable input
  section.childNodes[1].setAttribute('disabled', ''); // change UI to reflect input

  section.classList.add('disabled');
  section.classList.remove('enabled'); // binde enable function
...
window.onload = function () {
  // gather array items
  var items = document.getElementsByClassName('array-item'); // set onclick functions to either disable or enable input
